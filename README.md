...
发现新版本时，右下角会显示提示。点击「打开发布页」前往下载，也可选择「以后再说」或「不再提示此版本」；忽略当前版本后，更高版本仍可提示。

![汉化更新提示：当前 v12.27.5，发现新版本 v12.27.7](assets/screenshots/03-update-prompt-cn.png)

历史实测示例（2026-09-12）：独立启动已发布的 v12.27.5，自动显示 v12.27.7 汉化包更新提示。图中版本仅作示例。
